					...
					<div class="col-xl-7 col-lg-7">
						<div class="main-menu  d-none d-lg-block">
                            ...
                            <ul id="navigation">
                                    ...
                                    <li><a class="active" href="events.php">Eventos</a></li>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-6 col-md-6">
                        <div class="illastrator_png">
                            <img src="../../img/evento.svg" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
                        <div class="slider_info">
                            <h3>Eventos em<br>Criciúma!                                
                                </h3>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-100">
                        <h3>Saiba mais</h3>
                        <p>Saiba mais sobre os eventos de Criciúma!<br><br><br>
                        <p><a href="../../pesquisar.php" class="boxed_btn">Pesquisar eventos</a>
...
<div class="card-deck">
  <div class="card">
    <img class="card-img-top" src="../../img/<?=$arquivo?>" alt="Card image cap">
    <div class="card-body">
      ...
      $msg_sem = ($total_registros<=0)?"NÃO HÁ IMAGENS NO SISTEMA!" : "";

      while($linha = mysqli_fetch_assoc($resultado)){
             
     
     echo "<h5 class=\"card-title\">".$linha['name']."</h5>";
     echo "<p class=\"card-text\">".$linha['local']."</p>";
      }?>
  ...
  <div class="card">
    <img class="card-img-top" src="../../img/tanuki.jpg" alt="Card image cap">
    <div class="card-body">
      <h5 class="card-title">Tanuki</h5>
  ...
  <div class="card">
    <img class="card-img-top" src="../../img/etnia.jpg" alt="Card image cap">
    <div class="card-body">
